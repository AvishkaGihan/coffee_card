...
class _CoffeePrefsState extends State<CoffeePrefs> {
  int strength = 1; // Initial strength
  int sugars = 1; // Initial sugars

  void increaseStrength() {
    setState(() {
      strength = strength < 5 ? strength + 1 : 1; // Increment or reset to 1
    });
  }

  void increaseSugars() {
    setState(() {
      sugars = sugars < 5 ? sugars + 1 : 0; // Increment or reset to 0
    });
  }
